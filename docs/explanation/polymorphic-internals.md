...
本章解释 sqlmodel-ext 怎么把 SQLAlchemy 的两种多态继承（JTI 联表 / STI 单表）"打包"成几个简洁的 Mixin。要看怎么在自己的项目里定义 JTI/STI 模型，去 [定义 JTI 模型](/how-to/define-jti-models) 或 [定义 STI 模型](/how-to/define-sti-models)。
